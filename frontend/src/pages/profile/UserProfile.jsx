...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        const res = await axios.get('looter-bank-472gv7p05-mehedi-hasans-projects-1f9ebc78.vercel.app/api/auth/me', config);
        setUserData({
          name: res.data.name,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put('looter-bank-472gv7p05-mehedi-hasans-projects-1f9ebc78.vercel.app/api/auth/me', updateData, config);
